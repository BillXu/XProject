#include "NJMJPoker.h"
void NJMJPoker::init(Json::Value& jsOpt) {
	IMJPoker::init(jsOpt);
...
uint8_t NJMJPoker::getCardByIdx(uint16_t nIdx, bool isReverse) {
	if (isReverse) {
...
void NJMJPoker::makeSpecialCard(std::vector<uint8_t>& vMakedCards) {
#ifndef _DEBUG
	return;
#endif // !_DEBUG
	//return;
