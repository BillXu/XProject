#include "SZMJPoker.h"
void SZMJPoker::init(Json::Value& jsOpt) {
	IMJPoker::init(jsOpt);
...
uint8_t SZMJPoker::getCardByIdx(uint16_t nIdx, bool isReverse) {
	if (isReverse) {
...
void SZMJPoker::makeSpecialCard(std::vector<uint8_t>& vMakedCards) {
#ifndef _DEBUG
	return;
#endif // !_DEBUG
	//return;
