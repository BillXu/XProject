...
enum ROOM_MTT_PLAYER_STATE
{
	MTT_PLAYER_NOT_DRAGIN = 0,
	MTT_PLAYER_DRAGIN = 1, //开始后标识正在比赛中
	MTT_PLAYER_TOUT = 2,
};

enum ROOM_COSUME_DIAMOND_REASION
{
	ROOM_CREATE,
	ROOM_DELAY_GAME_TIME,
	ROOM_REPUT_CARDS,
	ROOM_DELAY_PUT_CARDS_TIME,
	CLUB_ADD_MEMBER_LIMIT = 4, //固定值club中调用请勿修改
};