...
void AHMJOpts::initRoomOpts(Json::Value& jsOpts) {
	IMJOpts::initRoomOpts(jsOpts);

	m_bEnableRace = jsOpts["guapu"].asBool();
...
uint16_t AHMJOpts::calculateDiamondNeed() {
#ifdef _DEBUG
	return 0;
#endif // _DEBUG
...
uint8_t AHMJOpts::calculateInitRound() {
#ifdef _DEBUG
	return 2;
#endif // _DEBUG
	auto nLevel = getRoundLevel();
