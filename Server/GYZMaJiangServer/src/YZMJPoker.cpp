#include "YZMJPoker.h"
void YZMJPoker::init(Json::Value& jsOpt) {
	IMJPoker::init(jsOpt);
...
uint8_t YZMJPoker::getCardByIdx(uint16_t nIdx, bool isReverse) {
	if (isReverse) {
...
void YZMJPoker::makeSpecialCard(std::vector<uint8_t>& vMakedCards) {
#ifndef _DEBUG
	return;
#endif // !_DEBUG
	//return;
